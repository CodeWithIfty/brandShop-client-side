    ...
    >
      <div className="flex-wrap sm:flex-nowrap flex items-center sm:gap-20 lg:gap-20">
        <div className="sm:w-1/2 lg:w-1/2 py-4 px-4">
          <div className="flex flex-col gap-4 w-full">
            <div className="w-full">
              <h2 className=" text-[#FF6600] text-2xl font-mono">
                Fresh From Foody
              </h2>
            ...
            <button
              type="submit"
              className=" border text-[#FF6600] rounded-full py-2 px-6 w-36 text-center"
            >
              View{" "}
            </button>
          </div>
        ...
        <div className="sm:w-1/2 lg:w-1/2  sm:p-2 lg:p-2 max-w-7xl mx-auto">
          <p className="bold text-center text-3xl font-bold tracking-wide uppercase my-4">
            Book a table
          </p>
          <form action="" className="flex flex-col gap-y-6">
            ...
            <button
              type="submit"
              className="self-center bg-[#FF6600] text-white rounded-full py-2 px-6 w-36 text-center"
            >
              Submit
            </button>
          </form>
