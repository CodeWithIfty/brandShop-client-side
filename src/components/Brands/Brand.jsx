...
export default function Brand({ name, img, variants }) {
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center w-full h-full absolute  z-20 hover:scale-150 transition duration-300 opacity-0 hover:opacity-100 hover:bg-[#FF6600] hover:bg-opacity-70 text-[#FF6600]  hover:text-white ]">
